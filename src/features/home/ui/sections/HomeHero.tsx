  ...
  return (
    <section className="px-3 md:px-3">
      <div className="bento-grid grid grid-cols-2 md:grid-cols-12 grid-rows-[280px_200px_180px] md:grid-rows-[320px_280px] gap-3">
        ...
        <Link href="/catalog?cat=Motores" className="col-span-2 md:col-span-7 md:row-span-2 relative overflow-hidden group cursor-pointer">
          <motion.div
        ...
        <Link href="/catalog?cat=Frenos" className="col-span-2 md:col-span-3">
          <motion.div
